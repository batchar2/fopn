...
// Имена sni-spoofing-* достались от прежних версий: на деле они всегда включали
// Reality. Держим их псевдонимами канонических reality-*, чтобы не ломать чужие
// конфиги.
